...
const STORIES = [
  ...
  pages: [
    ...
    {
      hebrew: 'לִפְנֵי לֹא הַרְבֵּה זְמַן הַדּוֹד שֶׁלִּי בִּיקֵּר אוֹתִי. הַדּוֹד שֶׁלִּי הוּא עַכְבַּר הָעִיר. כּוּלָּם יוֹדְעִים שֶׁהוּא מְאוֹד עָשִׁיר וְגָר בְּבַיִת גָּדוֹל בְּלֵב הָעִיר. הוּא תֵּאֵר אֶת כָּל מַה שֶׁאֶפְשָׁר לַחֲווֹת בָּעִיר – אוֹכֶל גוּרְמֶה, יַיִן מְשֻׁבָּח, וּמְגוּרִים מְפוֹאָרִים.',
      words: ['לִפְנֵי','לֹא','הַרְבֵּה','זְמַן','הַדּוֹד','שֶׁלִּי','בִּיקֵּר','אוֹתִי.','הַדּוֹד','שֶׁלִּי','הוּא','עַכְבַּר','הָעִיר.','כּוּלָּם','יוֹדְעִים','שֶׁהוּא','מְאוֹד','עָשִׁיר','וְגָר','בְּבַיִת','גָּדוֹל','בְּלֵב','הָעִיר.','הוּא','תֵּאֵר','אֶת','כָּל','מַה','שֶּׁאֶפְשָׁר','לַחֲווֹת','בָּעִיר','–','אוֹכֶל','גוּרְמֶה,','יַיִן','מְשֻׁבָּח,','וּמְגוּרִים','מְפוֹאָרִים.'],
    ...
    {
      hebrew: 'כְּשֶׁנִּכְנַסְנוּ לַמִּזְוָּוָה, הוּנְּחוּ עַל הַשֻּׁלְחָן שְׁרִידִים שֶׁל מִשְׁתֶּה מְפוֹאָר. טָעַמְנוּ גְּבִינַת גּוֹרְגּוֹנְזוֹלָה – מֵעוֹלָם לֹא טָעַמְתִּי גְּבִינָה טְעִימָה כָּל כָּךְ! אֲבָל אָז רָאִיתִי צֵל גָּדוֹל זָז בַּפִּינָה – וְהִתְנַפֵּל עָלֵינוּ חָתוּל נוֹרָא.',
      words: ['כְּשֶׁנִּכְנַסְנוּ','לַמִּזְוָּוָה,','הוּנְּחוּ','עַל','הַשֻּׁלְחָן','שְׁרִידִים','שֶׁל','מִשְׁתֶּה','מְפוֹאָר.','טָעַמְנוּ','גְּבִינַת','גּוֹרְגּוֹנְזוֹלָה','–','מֵעוֹלָם','לֹא','טָעַמְתִּי','גְּבִינָה','טְעִימָה','כָּל','כָּךְ!','אֲבָל','אָז','רָאִיתִי','צֵל','גָּדוֹל','זָז','בַּפִּינָה','–','וְהִתְנַפֵּל','עָלֵינוּ','חָתוּל','נוֹרָא.'],
    ...
    {
      hebrew: 'הַדּוֹד וַאֲנִי מִהַרְנוּ לָרוּץ, וְהַחָתוּל רָדַף אַחֲרֵינוּ. בְּקֹשִׁי נִמְלַטְנוּ. אָמַרְתִּי לַדּוֹד: "תּוֹדָה עַל הָאֵירוּחַ, אֲבָל אֲנִי חוֹזֵר הַבַּיְתָה. עָדִיף לֶאֱכוֹל שְׁעוּעִית בְּשֶׁקֶט מֵאֲשֶׁר לִזְלוֹל עוּגוֹת בְּפַחַד."',
      words: ['הַדּוֹד','וַאֲנִי','מִהַרְנוּ','לָרוּץ,','וְהַחָתוּל','רָדַף','אַחֲרֵינוּ.','בְּקֹשִׁי','נִמְלַטְנוּ.','אָמַרְתִּי','לַדּוֹד:','\"תּוֹדָה','עַל','הָאֵירוּחַ,','אֲבָל','אֲנִי','חוֹזֵר','הַבַּיְתָה.','עָדִיף','לֶאֱכוֹל','שְׁעוּעִית','בְּשֶׁקֶט','מֵאֲשֶׁר','לִזְלוֹל','עוּגוֹת','בְּפַחַד.\"'],
