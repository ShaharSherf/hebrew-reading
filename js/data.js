...
const STORIES = [
  ...
  pages: [
    {
      hebrew: 'הָיָה הָיָה פַּעַם עֵץ שֶׁאָהַב יֶלֶד קָטָן. וּבְכָל יוֹם הַיֶּלֶד הָיָה מַגִּיעַ וּמְשַׂחֵק עִם הָעֵץ, וְאוֹסֵף אֶת הֶעָלִים שֶׁנָּשְׁרוּ מֵהָעֵץ, וְעוֹשֶׂה מֵהֶם כֶּתֶר. הוּא הָיָה מְטַפֵּס עַל הַגֶּזַע שֶׁל הָעֵץ, וּמִתְנַדְנֵד מֵהָעֲנָפִים שֶׁלוֹ וְאוֹכֵל מֵהַתַּפּוּחִים שֶׁלוֹ. וְהַיֶּלֶד אָהַב אֶת הָעֵץ מְאוֹד. וְהָעֵץ הָיָה מְאֻשָּׁר.',
    ...
    {
      hebrew: 'הַרְבֵּה יָמִים עָבְרוּ וְהָעֵץ נִשְׁאַר לְבַד. וְאַחֲרֵי הַרְבֵּה הַרְבֵּה מְאוֹד זְמַן, הַיֶּלֶד חָזַר שׁוּב. "אֲנִי מְצִטַעֵר יֶלֶד," אָמַר הָעֵץ, "אֲבָל לֹא נִשְׁאַר לִי שׁוּם דָּבָר לָתֵת לְךָ... אֲנִי רַק גֶּדֶם עֵץ זָקֵן." "אֲנִי לֹא צָרִיךְ הַרְבֵּה עַכְשָׁו," אָמַר הַיֶּלֶד. "רַק מָקוֹם שָׁקֵט לָשֶׁבֶת וְלָנוּחַ. אֲנִי מְאוֹד עָיֵף." "גֶּדֶם עֵץ זָקֵן הוּא מְעֻלֶּה כְּדֵי שֶׁתּוּכַל לָשֶׁבֶת עָלָיו וְלָנוּחַ. בֹּא יֶלֶד, שֵׁב." וְהַיֶּלֶד הִתְיַשֵּׁב עַל הָעֵץ. וְהָעֵץ הָיָה מְאֻשָּׁר.',
      words: ['הַרְבֵּה','יָמִים','עָבְרוּ','וְהָעֵץ','נִשְׁאַר','לְבַד.','וְאַחֲרֵי','הַרְבֵּה','הַרְבֵּה','מְאוֹד','זְמַן,','הַיֶּלֶד','חָזַר','שׁוּב.','"אֲנִי','מְצִטַעֵר','יֶלֶד,"','אָמַר','הָעֵץ,','"אֲבָל','לֹא','נִשְׁאַר','לִי','שׁוּם','דָּבָר','לָתֵת','לְךָ...','אֲנִי','רַק','גֶּדֶם','עֵץ','זָקֵן."','"אֲנִי','לֹא','צָרִיךְ','הַרְבֵּה','עַכְשָׁו,"','אָמַר','הַיֶּלֶד.','"רַק','מָקוֹם','שָׁקֵט','לָשֶׁבֶת','וְלָנוּחַ.','אֲנִי','מְאוֹד','עָיֵף."','"גֶּדֶם','עֵץ','זָקֵן','הוּא','מְעֻלֶּה','כְּדֵי','שֶׁתּוּכַל','לָשֶׁבֶת','עָלָיו','וְלָנוּחַ.','בֹּא','יֶלֶד,','שֵׁב."','וְהַיֶּלֶד','הִתְיַשֵּׁב','עַל','הָעֵץ.','וְהָעֵץ','הָיָה','מְאֻשָּׁר.'],
  ...
  pages: [
    {
      hebrew: 'לִפְנֵי הַרְבֵּה מְאוֹד שָׁנִים, סִין הָיְתָה בְּמִלְחָמָה גְּדוֹלָה עִם שְׁבָטִים נוֹוְדִים מֵהַצָּפוֹן שֶׁרָצוּ לִכְבֹּשׁ אֶת סִין. הַקֵּיסָר שֶׁל סִין פִּרְסֵם צַו גִּיּוּס וּבוֹ הוֹרָאָה שֶׁאָדָם אֶחָד מִכָּל מִשְׁפָּחָה סִינִית חַיָּב לַעֲזֹב אֶת הַמִּשְׁפָּחָה שֶׁלּוֹ כְּדֵי לְהִתְגַּיֵּס לַצָּבָא.',
